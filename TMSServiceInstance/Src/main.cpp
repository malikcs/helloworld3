...
int main(void)
{
	...
	manifest->set_serviceclass("local.service.TMSService");
	manifest->set_description("TMSServiceImpl service");
	...
	manifest->add_servicedescriptor("file://param/DATA0201250.TAR");
	...
	TMSServiceImpl* serviceImpl = new TMSServiceImpl();
